...
function createPlatformFactory(parentPlatformFactory, name, providers = []) {
  ...
  return (extraProviders = []) => {
    ...
    if (!platform) {
      ...
      platform = (_a4 = parentPlatformFactory == null ? void 0 : parentPlatformFactory(platformProviders)) != null ? _a4 : createPlatform(createPlatformInjector(platformProviders, desc));
    }
...
function internalCreateApplication(config) {
  ...
  try {
    const platformInjector = (_a4 = platformRef == null ? void 0 : platformRef.injector) != null ? _a4 : createOrReusePlatformInjector(platformProviders);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-W5PXG6FY.js.map
